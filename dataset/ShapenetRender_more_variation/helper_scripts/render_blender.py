...
target_obj = None
bpy.ops.import_scene.obj(filepath=os.path.join(args.obj_dir, 'model.obj'))
...
scene.render.resolution_x = 512 #224
scene.render.resolution_y = 512 #224
...
# obj_image_dir = "/home/yirus/Datasets/PartSeg/train_test/02691156/1a04e3eab45ca15dd86060f189eb133"  # [args.obj_image_easy_dir, args.obj_image_hard_dir]
...
for j in range(1):
    ...
    for i in range(args.num_views):
        ...
        while True:
            ...
            scene.render.filepath = args.obj_dir + '/{0:02d}'.format(
                i)  #
            # print(".....................................................")
    ...
    with open(args.obj_dir + "/rendering_metadata.txt", "w") as f:
        f.write(metastring)
