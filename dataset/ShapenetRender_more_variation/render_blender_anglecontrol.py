...
parser.add_argument('--y_rot_range', type=int, default=5,
...
#print(f"numview:{args.views}, stepsize: {stepsize} deg")
print(stepsize)
...
for j in range(1):
    ...
    for i in range(args.views):
        ...
        while True:
            ...
            y_rot = current_rot_value + angle_rand[0] *  2 * args.y_rot_range - args.y_rot_range
            if j == 0:
...
#                dist = 0.60 + angle_rand[2] * 0.40
            ...
            break
        ## DISN saving format
        metastring_disn = metastring + "[{},{},{},{},{},{},{},{},{},{}], \n" \
                     .format(y_rot, x_rot, 0, dist, 35, 32, 1.75,
                        target_obj.location[0], target_obj.location[1], target_obj.location[2])
         ## 3d r2n2 saving format
        metastring = metastring + "{} {} {} {} {} {} {} {} {} {}\n" \
                     .format(y_rot, x_rot, 0, dist, 35, 32, 1.75,
                        target_obj.location[0], target_obj.location[1], target_obj.location[2])
       
    with open(obj_image_dir[j]+"/rendering_metadata_disn.txt", "w") as f:
        f.write(metastring_disn)
